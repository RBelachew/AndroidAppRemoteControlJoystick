...
*Note: The video says that in class MainActivity there is a field of ViewModel but in fact, MainActivity has no fields at all but it defines a ViewModel variable within a onCreate function through which it passes the values to ViewModel.
